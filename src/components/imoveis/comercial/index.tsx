...
export function ComercialGroup() {
  return(
    <section className="py-10 md:px-24 md:py-20">
      ...
      <div className="py-20 px-6 flex flex-col items-center justify-center gap-5">
        ...
        <p className="text-lg font-base text-center">No momento não temos nenhum imóvel comercial a venda. <br />Caso queira entrar em contato com o corretor, clique no botão abaixo.</p>
